...
import { useEffect, useState } from "react"; // 1. Tambahkan useState & useEffect
import Navbar from "../components/Navbar";
import LoadingServices from "./loading"; // 2. Import komponen skeleton yang tadi dibuat
import "../css/home.css";
...
export default function Services() {
  ...
  // 5. Jika status masih loading, tampilkan skeleton layout terlebih dahulu
  if (isLoading) {
    return (
      <>
        <Navbar />
  ...
  // Tampilan halaman asli kamu di bawah ini tetap sama
  return (
    <>
      <Navbar />
